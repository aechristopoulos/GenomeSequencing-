...
This primer is universal for the NS segment of all strains of Influenza A. The primer includes a 2 nucleotide long 5' tail (*italized*) that is not based on the sequences in order to increase the melting temperature and improve other factors of the primer; this tail was not included in the hamming distance calculations. The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), and part of the non-coding region that is unique to the NS segment. Based on the alignment shade threshold and hamming distance calculations, 91% of NS H3Nx sequences will have a hamming distance of 0 with this primer. 4654 H3N2 and 7 H3N8 (4,661 in total) sequences were used for this alignment and calculations.
...
This primer is universal for the NS segment of all strains of Influenza A. The primer includes a 2 nucleotide long 5' tail (*italized*) that is not based on the sequences in order to increase the melting temperature and improve other factors of the primer; this tail was not included in the hamming distance calculations. The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), and part of the non-coding region that is unique to the NS segment. Based on the alignment shade threshold and hamming distance calculations, 71% of NS H5Nx sequences will have a hamming distance of 0 with this primer. 3 H5N6 sequences, 2 H5N1 sequences and 1 H5N8 (6 in total) sequence were used for this alignment and calculations.
...
This primer is universal for the NS segment of all strains of Influenza A. The primer includes a 2 nucleotide long 5' tail (*italized*) that is not based on the sequences in order to increase the melting temperature and improve other factors of the primer; this tail was not included in the hamming distance calculations. The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), and part of the non-coding region that is unique to the NS segment. Based on the alignment shade threshold and hamming distance calculations, 84% of NS H7N9 sequences will have a hamming distance of 0 with this primer. 91 H7N9 sequences were used for this alignment and calculations.
...
This primer is universal for the NS segment of all strains of Influenza A. The primer includes a 2 nucleotide long 5' tail (*italized*) that is not based on the sequences in order to increase the melting temperature and improve other factors of the primer; this tail was not included in the hamming distance calculations. The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), and part of the non-coding region that is unique to the NS segment. Based on the alignment shade threshold and hamming distance calculations, 100% of NS H9N2 sequences will have a hamming distance of 0 with this primer. 29 H9N2 sequences were used for this alignment and calculations.
