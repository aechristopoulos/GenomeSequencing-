...
**Reverse compliment (without 5'tail)**: AAA AAC A**CC CTT GTT TCT ACT**
...
In total, **8,760 sequences** were used to design the HA primers. These sequences were downloaded from the NCBI Influenza database and the GSAID Influenza database. They were chosen based on length (had to include the non-coding regions) and quality of the sequence. 
