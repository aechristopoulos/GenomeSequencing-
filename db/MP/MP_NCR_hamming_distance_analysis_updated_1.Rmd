...
This primer is specific for the MP segment of H3Nx and H5Nx strains of Influenza A. The nucleotide differences from other strains are noted in *italics*. The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), the rest of the non-coding region that is unique to the MP segments, and the start of the coding region. Based on the alignment shade threshold and hamming distance calculations, 94% of MP H3Nx sequences will have a hamming distance of 0 with this primer. 6,997 H3N2 sequences and 4 H3N8 sequences were used for this alignment and calculations. 
...
This primer is universal for all MP segments of Influneza A. It is a mixed-base primer, with the mixed-based noted in *italics*.**Due to it being a mixed-base, the code reads the mixed-base nucleotides as mismatches. (I am working on fixing this issue and will update this once it is fixed.) Therefore, the actual hamming distances for this primer are 0 and 1 rather than 2 and 3.** The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), the rest of the non-coding region that is unique to the MP segments, and the start of the coding region. Based on the alignment shade threshold and hamming distance calculations, 94% of MP H3Nx sequences will have a hamming distance of 0 with this primer. 6,997 H3N2 sequences and 4 H3N8 sequences were used for this alignment and calculations. **I think that we should use this primer** 
...
This primer is specific for the MP segment of H3Nx and H5Nx strains of Influenza A. The nucleotide differences from other strains are noted in *italics*. The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), the rest of the non-coding region that is unique to the MP segments, and the start of the coding region. Based on the alignment shade threshold and hamming distance calculations, 87% of MP H5Nx sequences will have a hamming distance of 1 with this primer. 10 H5N6 sequences, 2 H5N1 sequences, and 1 H5N8 sequence (13 total) were used for this alignments and calculations. 
...
This primer is universal for all MP segments of Influneza A. It is a mixed-base primer, with the mixed-based noted in *italics*.**Due to it being a mixed-base, the code reads the mixed-base nucleotides as mismatches. (I am working on fixing this issue and will update this once it is fixed.) Therefore, the actual hamming distances for this primer are 0 and 1 rather than 2 and 3.** The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), the rest of the non-coding region that is unique to the MP segments, and the start of the coding region. Based on the alignment shade threshold and hamming distance calculations, 87% of MP H5Nx sequences will have a hamming distance of 0 with this primer. 10 H5N6 sequences, 2 H5N1 sequences, and 1 H5N8 sequence (13 total) were used for this alignments and calculations. **I think that we should use this primer** 
...
This primer is universal for all MP segments of all strains of Influenza A. The reverse compliment of this primer was used for the alignments and hamming distance calculations. The primer includes a 9 nucleotide long 5' tail (*italized*) that is not based on the sequences in order to increase the melting temperature and improve other factors of the primer; this tail was not included in the hamming distance calculations. The rest of the primer consists of the universal non-coding region (AGT AGA AAC AAG G, **bolded**) and part of the non-coding region that is unique to the MP segments. Based on the alignment shade threshold and hamming distance calculations, 100% of MP H5Nx sequences will have a hamming distance of 0 with this primer. 10 H5N6 sequences, 2 H5N1 sequences, and 1 H5N8 sequence (13 total) were used for this alignments and calculations. 
...
This primer is specific for the MP segment of H1Nx, H7N9, and H9N2 strains of Influenza A. The nucleotide differences from other strains are noted in *italics*. The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), the rest of the non-coding region that is unique to the MP segments, and the start of the coding region. Based on the alignment shade threshold and hamming distance calculations, 70% of MP H7N9 sequences will have a hamming distance of 0 with this primer. 184 H7N9 sequences were used for this alignment and calculations. 
...
This primer is universal for all MP segments of all strains of Influenza A. The reverse compliment of this primer was used for the alignments and hamming distance calculations. The primer includes a 9 nucleotide long 5' tail (*italized*) that is not based on the sequences in order to increase the melting temperature and improve other factors of the primer; this tail was not included in the hamming distance calculations. The rest of the primer consists of the universal non-coding region (AGT AGA AAC AAG G, **bolded**) and part of the non-coding region that is unique to the MP segments. Based on the alignment shade threshold and hamming distance calculations, 100% of MP H7N9 sequences will have a hamming distance of 0 with this primer. 184 H7N9 sequences were used for this alignment and calculations. 
...
This primer is specific for the MP segment of H1Nx, H7N9, and H9N2 strains of Influenza A. The nucleotide differences from other strains are noted in *italics*. The primer consists of the universal non-coding region (AGC AAA AGC AGG, **bolded**), the rest of the non-coding region that is unique to the MP segments, and the start of the coding region. Based on the alignment shade threshold and hamming distance calculations, 97% of MP H9N2 sequences will have a hamming distance of 0 with this primer. 32 H9N2 sequences were used for this alignment and calculations.
...
This primer is universal for all MP segments of all strains of Influenza A. The reverse compliment of this primer was used for the alignments and hamming distance calculations. The primer includes a 9 nucleotide long 5' tail (*italized*) that is not based on the sequences in order to increase the melting temperature and improve other factors of the primer; this tail was not included in the hamming distance calculations. The rest of the primer consists of the universal non-coding region (AGT AGA AAC AAG G, **bolded**) and part of the non-coding region that is unique to the MP segments. Based on the alignment shade threshold and hamming distance calculations, 100% of MP H9N2 sequences will have a hamming distance of 0 with this primer. 32 H9N2 sequences were used for this alignment and calculations.

In total, **11,218** sequences were used to design the MP primers. These sequences were downloaded from the NCBI Influenza database and the GSAID Influenza database. They were chosen based on length (had to include the non-coding regions) and quality of the sequence. **I believe that using the Forward 1.7 primer (mixed-base) and Reverse 2.2 primer pair would be best.** However, we could also do a three primer pool with an equal concentration of Forward 1.5 and Forward 1.6, and Reverse 2.2. 